...
/*
👉 Abstraction (Complex logic hide karna) 

User ko nahi pata:
deposit me kya validation ho raha
withdraw me kya checking ho rahi
balance kaise update ho raha
invalid amount kaise detect ho raha
User ko sirf simple functions call karne h:

c1.deposit(500);
c1.withdraw(200);

Baki pura internal logic hide hai.
👉 Ye hoti hai Abstraction → internal complexity hide karna.
Simple line:

Abstraction = Sirf necessary functions dikhana, details hide karna.
*/